...
public extension Double {
    ...
    func pressure(unitStyle: Formatter.UnitStyle = .medium, minFraction: Int? = nil, maxFraction: Int? = nil, groupSize: Int? = nil) -> String {
        let data = Measurement(value: self, unit: UnitPressure.hectopascals)
    ...
    func windSpeed(unitStyle: Formatter.UnitStyle = .medium, minFraction: Int? = nil, maxFraction: Int? = nil, groupSize: Int? = nil) -> String {
        let data = Measurement(value: self, unit: UnitSpeed.metersPerSecond)
    ...
    func windDirection(unitStyle: Formatter.UnitStyle = .medium, minFraction: Int? = nil, maxFraction: Int? = nil, groupSize: Int? = nil) -> String {
        let data = Measurement(value: self, unit: UnitAngle.degrees)
